...
<div class="flex items-center">
    <div class="md:w-1/2 md:mx-auto">
        <div class="rounded shadow">
            ...
            @endif
            <form class="w-full" method="post" action="{{ url('/threads') }}" >
            {{ csrf_field() }}
            <div class="bg-white p-3 rounded-b">
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border  rounded py-3 px-4 mb-3 {{ $errors->has('title') ? 'border-red-dark' : 'border-grey-lighter' }}" id="input-title" name="title" type="text" value="{{ old('title') }}" />
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <textarea class="appearance-none block w-full bg-grey-lighter text-grey-darker border {{ $errors->has('body') ? 'border-red-dark' : 'border-grey-lighter' }} rounded py-3 px-4 mb-3 h-24" name="body" id="input-body">{{ old('body') }}</textarea>
                    </div>
                </div>
